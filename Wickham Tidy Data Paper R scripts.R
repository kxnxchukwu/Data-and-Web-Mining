...
install.packages("stringer", "reshape2", "plyr", dependencies = TRUE)
library("stringr")
library("reshape2")
library("plyr")
...
getwd()
setwd("C:/Users/User/Documents/NCI20-21_Sem3/DWM HDSDA_JAN/Lecture 2 AssocRules")
...
######################################
# Completing Tidying to match HW video
######################################
test = melt(raw,"religion")

head(test)
names(test) <- c("religion", "income", "n")
